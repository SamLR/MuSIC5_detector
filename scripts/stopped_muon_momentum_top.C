...
void stopped_muon_momentum_top(){    
    ...
    for(unsigned int i = 0; i < n_targets; ++i) {
        const TString img_prefix = "../../../images/"+runname+"/init_momentum_of_muons_stopped_in_"+stopping_targets[i];
        const TString save_file_name = "init_mom_of_muons_stopped_in_"+stopping_targets[i]+"_"+deg+"_0.5_1_5_8_12mm";
